...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">My goal is to acquire the knowledge and skills necessary to excel in the IT industry and contribute to innovative solutions in the ever-evolving digital world.</p>
